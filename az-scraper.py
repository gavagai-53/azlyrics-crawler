...
# And now let's construct our generator of urls to crawl.
def build_url():
    for l in links:
        url = ('https://www.azlyrics.com'+l['href'][2:])
        yield url
urls = build_url()
...
for url in urls:
    ...
    # Sleep a bit. We don't want to crawl too fast.
    # Not only out of good practice, but also because AZLyrics will also ban your IP for a while if you don't wait. Be patient.
    time.sleep(3)
